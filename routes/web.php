...
Route::get('/book-table', [BookingController::class, 'index'])->name('book.table');
Route::post('/book-table', [BookingController::class, 'store'])->name('book.store');

Route::get('/payment/{booking_id}/{amount}', [BookingController::class, 'payment'])->name('payment');
Route::get('/payment-success/{booking_id}', [BookingController::class, 'paymentSuccess'])->name('payment.success');
